...
(() => {
    const obj = {en: "Input Amount: %d", ru: "Требуемое количество: %d", de: "Eingabebetrag: %d", es: "Cantidad de entrada: %d", pt: "Quantidade de entrada: %d", sv: "Ingångsbelopp: %d", zh: "投入金额: %d"};
    obj[Translation.getLanguage()] ??= obj.en;
